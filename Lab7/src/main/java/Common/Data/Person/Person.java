...
public class Person implements Serializable,Comparable<Person>,Cloneable{
     ...
     */
    public Person(Integer id, String name, Coordinates coordinates, int height,
                  LocalDateTime birthday, Color eyeColor, Color hairColor, Location location, User user) {
        if (id < 0) {
...
//    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, coordinates, creationDate, height, birthday, eyeColor, hairColor, location,user);
    }
